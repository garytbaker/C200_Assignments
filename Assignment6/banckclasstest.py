...
f.write("<style> h1{color: blue} h2{color: green} </style>")
f.write("<h1>Unit Testing</h1>")
f.write("<pid='date'></p></p><script>document.getElementById('date').innerHTML=Date();</script>")

testID= 1
f.write("<h2> Test {0}: Beginning Accounts </h2>".format(testID))
...
f.write("<ol>")
f.write("<li> Kaiser witdraws $10 </li>")
people[0].deposit(10)
...
f.write("<li> Shilah withdraws $2 </li>")
people[2].withdraw(2)
